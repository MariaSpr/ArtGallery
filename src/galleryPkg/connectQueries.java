...
//    ++++++++++++++++++++++++++++++INSERT FRAME METHODS+++++++++++++++++++++++++++++++
    ...
    public static boolean insertArtistInsertFrame(String name, String style, String loc, int phone){
        ...
        try{
            if(name.equalsIgnoreCase("") || style.equalsIgnoreCase("") || loc.equalsIgnoreCase("") || phone==0){
                JOptionPane.showMessageDialog(null, "All fields must be filled. Try Again."); 
                return false;
            } else if (phone==1){
                return false;
            }
    ...
    public static boolean insertArtworkInsertFrame(String title, int orderId, int artistId, String genre, float price, int crYear, int inYear){
        ...
        try{
            if(title.equalsIgnoreCase("") || genre.equalsIgnoreCase("") || price==0 || crYear==0 || inYear==0){
                JOptionPane.showMessageDialog(null, "All fields must be filled. Try Again."); 
                return false;
            } else if (price==1 || crYear==1 || inYear==1){
                return false;
            }
    ...
    public static boolean insertCustomerInsertFrame(String name, int phone){
            PreparedStatement pst = null;
        try{
            if(name.equalsIgnoreCase("") || phone==0){
                JOptionPane.showMessageDialog(null, "All fields must be filled. Try Again."); 
                return false;
            } else if (phone==1){
                return false;
    ...
    public static boolean insertOrderInsertFrame(String title, int custId, int orderYear){
        ...
        try{
            ...
            if(title.equalsIgnoreCase("") || orderYear==0){
                JOptionPane.showMessageDialog(null, "All fields must be filled. Try Again."); 
                return false;
            } else if (orderYear==1){
                return false;
    ...
    public static boolean insertNameOfGroupInsertFrame(String nameOfGroup){
        ...
        try{
            if(nameOfGroup.equalsIgnoreCase("")){
                JOptionPane.showMessageDialog(null, "All fields must be filled. Try Again."); 
                return false;
            }
...
//    ++++++++++++++++++++++ CHECK TEXTFIELD VALUE METHOD ++++++++++++++++++++++++++++
    
    //CHECK TXT FIELD INT.
    public static int checkTextFieldInt(javax.swing.JTextField txt){
        int x;
    ...
    //CHECK TXT FIELD FLOAT.
    public static float checkTextFieldFloat(javax.swing.JTextField txt){
        float x;
